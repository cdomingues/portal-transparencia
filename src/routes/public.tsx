...
const publicRoutes = [
  ...
  },
  {
    ...
    link: "http://www.transparencia.pmmc.com.br/relatorio-resumido-de-execucao-orcamentaria",
  },
  {
    name: "Relatório Gestão Fiscal",
    path: "/relatorio-gestao",
    element: <div></div>,
    icon: AiOutlineFileProtect,
    link: "http://www.transparencia.pmmc.com.br/relatorio-de-gestao-fiscal",
  },
  {
    ...
    group: [
      {
        ...
        path: "/balancos",
        icon: AiOutlineProfile,
        link: "http://www.transparencia.pmmc.com.br/balancos-anuais",
      },
      {
        name: "Pareceres do Tribunal",
        path: "/pareceres-tribunal",
        icon: AiOutlineProfile,
        link: "http://www.transparencia.pmmc.com.br/pareceres-do-tribunal",
      },
    ],
  },
  {
