  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Folha de Pagamento - Estagiários', href: '/gestao-de-pessoas/folha-pagamento-estagiarios' },
        ...
        { label: 'Regras e tabela de pagamento de diárias', href: '/gestao-de-pessoas/regras-pagamento-diarias' },
