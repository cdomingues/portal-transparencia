        ...
        <Stack direction="column">
          ...
          <Stack direction="row" flexWrap="wrap-reverse" mt='10px'>
            ...
            >
              ...
              <Divider width="100%" height={"2px"} backgroundColor={colors.primaryDefault40p} />
      ...
      {item?.detalhe ? (
        <Accordion allowMultiple>
          <AccordionItem>
            <h2>
              <AccordionButton>
                <Heading mb={1} fontSize={accessibility?.fonts?.medium} color={colors.primaryDefault40p} marginTop={2}>
                  Detalhes:
                </Heading>
                <AccordionIcon />
              </AccordionButton>
