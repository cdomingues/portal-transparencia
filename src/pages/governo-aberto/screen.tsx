...
function Screen({ handler }: PropsInput) {
  ...
  return (
    ...
    <Text
      ...
      mt="20px"
    >
    Decreto nº 22.203, de 11 de outubro de 2023 - <Link href='http://leismunicipa.is/0vxjy' target="blank" style={{ color: "#db334f" }}> http://leismunicipa.is/0vxjy</Link>
...
<br/>
Pensando nisso, a Prefeitura de Mogi das Cruzes, por meio da Secretaria de Transparência e Dados Abertos, realizou o processo de elaboração do seu 1º Plano de Ação Mogiano de Governo Aberto.   
<br/>
...
15h00 - Transparência 
<br/>
16h00 - Tecnologia e Inovação 
<br/>
17h00 - Participação Cidadã  <br/> </Text>
