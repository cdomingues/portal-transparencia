...
const menuItems = [
      ...
      submenu: [
        { label: 'Ciclo orçamentário', href: '#',
          submenu: [
            ...
            { label: "Aprovação de Contas pelo Legislativo", href: "http://www.cmmc.com.br/paginas/contas_do_executivo_municipal/" }
          ]
         },
      ...
      submenu: [
        { label: 'Contratos e ATAS', href: '#',
          submenu: [
            ...
            {label: "Contratos de gestãos",href: "/contratos-atas/contratos-gestao", },
   ...
   
    {
      ...
      href: '#',
      submenu: [
        { label: 'Leis e Decretos Municipais', href: '/leis-decretos-portarias/protocolo-geral' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Ouvidoria', href: 'https://www.mogidascruzes.sp.gov.br/servico/ouvidoria' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Prestação de contas simplificada', href: '/indicadores' },
        { label: 'Prestação à CMMC', href: 'http://localhost:3000/ciclo-orcamentario/prestacao-de-contas' },
      ]
    },
    {
      ...
      {items.map((item, index) => (
        <div
          ...
          className={`p-3 rounded-lg shadow-md ${
            level === 0 ? "bg-blue-500 text-white font-bold" : "bg-gray-100 text-gray-800"
          } transition duration-300`}
        >
          {item.href !== "#" ? (
            <Link href={item.href} className="block hover:text-blue-600 transition duration-300">
              {item.label}
            </Link>
          ) : (
            <span>{item.label}</span>
          )}
          {item.submenu && <div className="mt-2">{renderMenuItems(item.submenu, level + 1)}</div>}
        </div>
      ))}
    </div>
  );
