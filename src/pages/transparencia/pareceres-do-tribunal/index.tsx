...
function Controller() {
  ...
  const makeRequestFile = async () => {
    const response = await axios.get(
      ...
      {
        params: {
          url: `http://www.licitacao.pmmc.com.br/Transparencia/arquivos?ano=&tipo=7&pagina=1&tamanho=100000`,
        },
      }
    );
  ...
  const handleSelectValue = async (value: number) => {
    ...
    const response = await axios.get(
      ...
      {
        params: {
          url: `http://www.licitacao.pmmc.com.br/Transparencia/arquivos?ano=${value}&tipo=7&pagina=1&tamanho=100000`,
        },
      }
    );
