...
//     const response = await getFile("promae.json");
//     if (!response?.data) {
//       return;
//     }
...
function Controller() {
  ...
  const makeRequestFile = async () => {
    const response = await axios.get(
      ...
      {
        params: {
          url: `http://www.licitacao.pmmc.com.br/Transparencia/arquivos?ano=&tipo=11&pagina=1&tamanho=100000`,
        },
      }
    );
  ...
  const handleSelectValue = async (value: number) => {
    ...
    const response = await axios.get(
      ...
      {
        params: {
          url: `http://www.licitacao.pmmc.com.br/Transparencia/arquivos?ano=${value}&tipo=11&pagina=1&tamanho=100000`,
        },
      }
    );
