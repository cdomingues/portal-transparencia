...
import gestores_fiscais_encerrados from '../../../../data/gestores_fiscais_encerrados.json'
...
function Screen({ handler }: PropsInput) {
  ...
  return (
    ...
    <Table overflowX={'auto'} variant="striped"
      ...
      <Tbody>
        {gestores_fiscais_encerrados.map(info => (
    ...
    <DadosAbertos data={gestores_fiscais_encerrados} />
