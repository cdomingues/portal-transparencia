...
export const contentMapSite = {
  ...
  description:
    "Redirecionando para o site https://dados.mogidascruzes.sp.gov.br/  ",
};

function redirecionarParaLinkExterno() {
  setTimeout(function () {
    window.location.href = 'https://dados.mogidascruzes.sp.gov.br/ '; // Substitua pelo seu link externo
