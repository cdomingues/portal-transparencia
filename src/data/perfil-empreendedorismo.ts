...
export const descriptionEmpreendedorismo = [
  {
  ...
  {
    label: "Quantidade de empregos gerados",
    value: "455.587",
    icon: BiMale,
    year: "2021",
    labelDescription: "",
  ...
  {
    label: "Quantidade de grandes empresas",
    value: "544,12",
    icon: BiStreetView,
    year: "2010",
    labelDescription: "",
...
export default descriptionEmpreendedorismo;
